        ...
        <div class="min-height-200px">
            ...
            <div class="invoice-wrap">
                <div class="invoice-box">
                    ...
                    <div class="row pb-30">
                        <div class="col-md-6">
                            <h5 class="mb-15">Nom du Patient: Firmin</h5>
                        ...
                        <div class="col-md-6">
                            <div class="text-right">
                                @if ($medicalRecord->doctor)
                                    <p class="font-14 mb-5">Nom du Médecin: <strong class="weight-600">Grace</strong></p>
                    ...
                    <div class="invoice-desc pb-30">
                        ...
                        <div class="invoice-desc-body">
                            <ul>
                                <li class="clearfix">
                                    <div class="invoice-sub">Fièvre, maux de tête</div>
                                    <div class="invoice-rate">Possible grippe</div>
                                    <div class="invoice-hours">Repos, hydratation, médicaments contre la fièvre</div>
                                </li>
                            </ul>
                        </div>
                    </div>
